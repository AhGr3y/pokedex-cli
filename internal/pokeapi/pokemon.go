...
func (pc PokeClient) GetPokemon(name string) (Pokemon, error) {
	if name == "" {
		return Pokemon{}, fmt.Errorf("missing pokemon name")
	}
	...
	if err != nil {
		return Pokemon{}, fmt.Errorf("error doing request: %w", err)
	}
